                ...
                <tbody>
                    <?php
                        try{
                            ...
                            $sqlquery="";
                           {
                                $sqlquery="SELECT * FROM prescription_upload ";
                            }
                                ...
                                foreach($prestable as $row){
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo $row['Prescription'] ?>"download>
                                                <img width="150" height="150" alt="No Image found" src="<?php echo $row['Prescription'] ?>"></a>
                                            </td>
