...
<?php
$query= "SELECT * FROM Medicine ORDER BY Medicine_number ASC" ;
     ...
     <div class="table-responsive">  
          <table class="table table-bordered">  
               ...
               <tr>  
                    ...
                    <td><a href="viewmedicine.php?action=delete&id=<?php echo $values["item_Medicine_number"]; ?>"><span class="text-danger">Remove</span></a></td>  
               </tr>  
               <?php  
